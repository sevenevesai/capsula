// ChatGPT Export Extension v2.3 - Bug fixes and improvements
// Fixed duplications, selection behavior, export formats, and added scroll indicator
...
/* ===========================
   Harvester Module (Fixed Deduplication)
   =========================== */
const Harvester = {
  async harvest() {
    const meta = {
  ...
  findMessageElements() {
    ...
    selectors.forEach(sel => {
      document.querySelectorAll(sel).forEach(el => {
        // Skip if element is nested within another message element
...
// Keep remaining code (ContextMenu, KeyboardShortcuts, OverlayManager, PanelManager, NotificationManager, App) unchanged...
/* ===========================
   Panel Manager
   =========================== */
const PanelManager = {
