...
const TutorialConfig = {
  ...
  flows: {
    ...
    timelineSelection: {
      ...
      trigger: 'timeline-interact',
      priority: 2,
      steps: [
        {
          id: 'timeline-1',
          title: '🖱️ Timeline Selection',
          description: 'Click and drag on the timeline to select a range of messages for export.',
        ...
        {
          id: 'timeline-2',
          title: '⌨️ Multi-Selection',
          description: '<strong>Ctrl+Click:</strong> Toggle individual messages<br><strong>Shift+Click:</strong> Extend selection<br><strong>Ctrl+Drag:</strong> Add/remove while dragging',
          target: '.timeline-track',
          position: 'right',
          buttons: ['skip', 'next']
        },
        {
          ...
          description: 'Right-click anywhere on the timeline to instantly clear all selections and start fresh.',
          target: '.timeline-track',
          position: 'right',
          buttons: ['got-it']
        }
    ...
    messageToggles: {
      ...
      steps: [
        {
          id: 'toggles-1',
          title: '☑️ Message Toggles',
          description: 'Each message has a checkbox button. Click it to include or exclude that specific message from your export.',
          target: '.message-toggle-btn',
          position: 'right',
          buttons: ['skip', 'next']
        },
        {
          ...
          description: 'Excluded messages appear greyed out with stripes. Click them to expand and review before exporting.',
          target: '.chat-preview',
          position: 'left',
          buttons: ['skip', 'next']
        },
        {
          id: 'toggles-3',
          title: '🔗 Synced with Timeline',
          description: 'Message toggles and timeline selections work together. Changes in one instantly update the other!',
          target: '.timeline-panel',
          position: 'right',
          buttons: ['got-it']
        }
